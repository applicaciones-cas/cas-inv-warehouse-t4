 ...
 * @author MNV t4
 */
public class InventoryStockClusterIssuance_Hospitality implements GValidator {
    ...
    public JSONObject validate() {
        try {
            ...
            Logger.getLogger(InventoryStockClusterIssuance_Hospitality.class.getName()).log(Level.SEVERE, null, ex);
            poJSON = new JSONObject();
            poJSON.put("result", "error");
