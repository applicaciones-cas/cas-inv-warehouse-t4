 ...
 */
public class InventoryStockRequestApproval_Appliance implements GValidator {
    ...
    public JSONObject validate() {
        try {
            ...
            Logger.getLogger(InventoryStockRequestApproval_Appliance.class.getName()).log(Level.SEVERE, null, ex);
        }
