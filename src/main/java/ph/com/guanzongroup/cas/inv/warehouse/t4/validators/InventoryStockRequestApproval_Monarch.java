 ...
 */
public class InventoryStockRequestApproval_Monarch implements GValidator {
    ...
    public JSONObject validate() {
        try {
            ...
            Logger.getLogger(InventoryStockRequestApproval_Monarch.class.getName()).log(Level.SEVERE, null, ex);
        }
