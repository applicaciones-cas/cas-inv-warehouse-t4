 ...
 */
public class InventoryStockRequestApproval_MP implements GValidator {
    ...
    public JSONObject validate() {
        try {
            ...
            Logger.getLogger(InventoryStockRequestApproval_MP.class.getName()).log(Level.SEVERE, null, ex);
        }
