 ...
 * @author MNV t4
 */
public class InventoryStockIssuance_Vehicle implements GValidator {
    ...
    public JSONObject validate() {
        try {
            ...
            Logger.getLogger(InventoryStockIssuance_Vehicle.class.getName()).log(Level.SEVERE, null, ex);
            poJSON = new JSONObject();
            poJSON.put("result", "error");
