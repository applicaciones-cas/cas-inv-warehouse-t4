 ...
 */
public class InventoryStockRequestApproval_LP implements GValidator {
    ...
    public JSONObject validate() {
        try {
            ...
            Logger.getLogger(InventoryStockRequestApproval_LP.class.getName()).log(Level.SEVERE, null, ex);
        }
