 ...
 * @author MNV t4
 */
public class InventoryStockClusterIssuance_General implements GValidator {
    ...
    public JSONObject validate() {
        try {
            ...
            Logger.getLogger(InventoryStockClusterIssuance_General.class.getName()).log(Level.SEVERE, null, ex);
            poJSON = new JSONObject();
            poJSON.put("result", "error");
