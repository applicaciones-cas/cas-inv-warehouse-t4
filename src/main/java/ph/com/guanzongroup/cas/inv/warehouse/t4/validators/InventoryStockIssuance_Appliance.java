 ...
 * @author MNV t4
 */
public class InventoryStockIssuance_Appliance implements GValidator {
    ...
    public JSONObject validate() {
        try {
            ...
            Logger.getLogger(InventoryStockIssuance_Appliance.class.getName()).log(Level.SEVERE, null, ex);
            poJSON = new JSONObject();
            poJSON.put("result", "error");
