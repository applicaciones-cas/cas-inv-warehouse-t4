 ...
 */
public class InventoryStockRequestApproval_MC implements GValidator {
    ...
    public JSONObject validate() {
        try {
            ...
            Logger.getLogger(InventoryStockRequestApproval_MC.class.getName()).log(Level.SEVERE, null, ex);
        }
