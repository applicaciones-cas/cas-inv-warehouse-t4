 ...
 */
public class InventoryStockRequestApproval_General implements GValidator {
    ...
    public JSONObject validate() {
        try {
            ...
            Logger.getLogger(InventoryStockRequestApproval_General.class.getName()).log(Level.SEVERE, null, ex);
        }
